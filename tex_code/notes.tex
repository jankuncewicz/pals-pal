...
\begin{document}
	...
	For futher terms see 
	\href{https://dlmf.nist.gov/10.21.E19}{\texttt{https://dlmf.nist.gov/10.21.E19}}.
	
	For zeros $j_{v,m}$ where $v > 0$ I just put it in bounds $j_{v-1,m-1} < j_{v,m} < j_{v-1,m+1}$
	and approximated using Newton's formula until I got what I wanted. I check values for
